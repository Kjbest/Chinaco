...
class AdminContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/Applications/MAMP/htdocs/prestashop_1.7.7.4/modules/productcomments/src/Entity']);
        $d->addExcludePaths([0 => '/Applications/MAMP/htdocs/prestashop_1.7.7.4/modules/productcomments/src/Entity/index.php']);

        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/Applications/MAMP/htdocs/prestashop_1.7.7.4/src/PrestaShopBundle/Entity']), 'PrestaShop');
        ...
        $a->setProxyDir('/Applications/MAMP/htdocs/prestashop_1.7.7.4/var/cache/prod//doctrine/orm/Proxies');
        $a->setProxyNamespace('Proxies');
        $a->setAutoGenerateProxyClasses(false);
        $a->setClassMetadataFactoryName('Doctrine\\ORM\\Mapping\\ClassMetadataFactory');
        $a->setDefaultRepositoryClassName('Doctrine\\ORM\\EntityRepository');
        $a->setNamingStrategy(${($_ = isset($this->services['prestashop.database.naming_strategy']) ? $this->services['prestashop.database.naming_strategy'] : ($this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('cs_'))) && false ?: '_'});
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_eab0db9911002edc3577d9bb1af907a41ae925006f65df00d8c767e1f3cbcad2');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/Applications/MAMP/htdocs/prestashop_1.7.7.4/var/cache/prod//localization');
    }
    ...
    {
        return $this->services['product_comment_criterion_repository'] = new \PrestaShop\Module\ProductComment\Repository\ProductCommentCriterionRepository(${($_ = isset($this->services['doctrine.dbal.default_connection']) ? $this->services['doctrine.dbal.default_connection'] : $this->getDoctrine_Dbal_DefaultConnectionService()) && false ?: '_'}, 'cs_');
    }
    ...
    {
        return $this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('cs_');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.root_dir' => '/Applications/MAMP/htdocs/prestashop_1.7.7.4/app',
            'kernel.project_dir' => '/Applications/MAMP/htdocs/prestashop_1.7.7.4',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => '/Applications/MAMP/htdocs/prestashop_1.7.7.4/var/cache/prod/',
            ...
            'ps_cache_dir' => '/Applications/MAMP/htdocs/prestashop_1.7.7.4/var/cache/prod/',
            ...
            'doctrine.orm.proxy_dir' => '/Applications/MAMP/htdocs/prestashop_1.7.7.4/var/cache/prod//doctrine/orm/Proxies',
